...
const DraggableTask = React.memo(
  ({ id, index, moveTask, deleteTask, value, onChange }) => {
...
function All_tasks() {
  ...
  const handleInputChange = useCallback((index, newValue) => {
    setInputFields((prevFields) => {
      const newFields = [...prevFields];
      ...
      <div className="bg-zinc-700 w-full h-screen">
        ...
        >
          <div className="flex items-center justify-between">
            <h1
              className={`text-zinc-100 font-playwrite text-2xl ${
